...
|---|---|---|
| [JurisData Analytics](https://github.com/fabriciogmaraes/jurisdata-analytics) | Labor litigation pipeline with NLP, clustering and LLM applied to 40k+ real decisions from TRT-21/RN | Python · PostgreSQL · scikit-learn · Llama 3.3 70b · Groq API |
